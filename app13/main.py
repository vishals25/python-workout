...
class SearchDialog(QDialog):
    ...
    def searchstudent(self):
        ...
        connection=DataBaseConnection().connect()
        cursor=connection.cursor()
        result=cursor.execute("select * from students where name=?",(name,)) #tuple
...
class EditDialog(QDialog):
    ...
    def editstudent(self):
        ...
        connection=DataBaseConnection().connect()
        cursor=connection.cursor()
        cursor.execute("update students set (name,course,mobile)=(?,?,?) where  id=(?)",(name,course,mobile,self.id))
        connection.commit()
        cursor.close()
        connection.close()
